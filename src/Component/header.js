...
import SignMessageModal from "../hooks/SignMessageModal";
        ...
        <div className="container">
          <div className="header_top_content">
            <div className="header_top_left">
              <p>
                Total Deposits: <strong>$3,613,715,490</strong>
              </p>
              <p>
                Daily Volume: <strong>$165,288,253</strong>
              </p>
            </div>
          ...
          <div className="header_content">
            ...
            <div className="dropwdown_list">
                <div className="dropwdown_state">
                  
                  <span className="dropwdown_name"> <SignMessageModal/></span>{" "}
                ...
                <ConnectKitButton.Custom>
                  {({
                    ...
                    return (
                      ...
                      <button onClick={show} className={isConnected ? "activeButton": ""}>
